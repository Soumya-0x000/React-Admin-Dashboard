...
const animateMenu = {
    initial: { x: -300, y: -20 },
    final: { x: 0, y: 0 },
    transition: { damping: 10, bounce: .6 },
}
...
const Sidebar = () => {
    ...
    const dataItems = [
        ...
        {title: 'Invoices balances', to: '/invoices', icon: ReceiptLongOutlinedIcon},
    ]
    const pagesItems = [
        ...
        sx={{
            ...
            <ProSidebar collapsed={isCollapsed} width={250} className=''>
                <Menu iconShape='square'>
                    ...
                    icon={isCollapsed ? <MenuOutlinedIcon sx={{fontSize: '2rem', color: colors.grey[300]}}/> : undefined }
                        ...
                        {!isCollapsed && (
                            <Box className='flex justify-between items-center'>
                                ...
                                <IconButton onClick={() => setIsCollapsed(!isCollapsed)}>
                                    <MenuOutlinedIcon sx={{fontSize: '1.7rem', color: colors.grey[300]}}/>
                                </IconButton>
                            </Box>
                        )}
                    </MenuItem>
                    ...
                    transition='transition'>
                        <motion.div variants={animateMenu} initial='initial' animate='final' transition={{delay: 0.1}}>
                            <Item 
